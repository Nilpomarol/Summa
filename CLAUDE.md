...
- `docs/06-roadmap.md` drives sequencing. Phase 0A, Phase 0B, and Phase 0C are complete; next planned work is Phase 1 Android core-ledger work, starting with P1-1 UI/UX for accounts and movements.
