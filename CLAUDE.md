...
- `docs/06-roadmap.md` drives sequencing. Android Phase 0 through Phase 5 are complete. Phase 5R is next: read `docs/15-android-redesign-validation.md` before editing because this checkpoint combines Android logic validation with the full UI/UX redesign before Windows starts.
