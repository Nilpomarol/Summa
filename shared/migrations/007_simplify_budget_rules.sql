-- Gestor finances v6 -> v7 migration.
-- Budget rules recur by their period; their legacy activation date is removed.
-- Existing rows, including any older duplicate rules, are preserved.
