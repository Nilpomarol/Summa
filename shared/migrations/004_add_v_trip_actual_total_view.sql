...
-- trip-analysis work; not present in v1-v3 databases since Schema.create() at that time
...
-- exposing tag_id consistently on every branch. v_actual_expense has existed since the very
-- first shared-schema commit (before schema_version existed) purely via
