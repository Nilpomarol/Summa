...
/**
 * Whether this device may currently write to the shared database (docs/02-synchronization.md).
 * A no-op seam ahead of Phase 7: [AppContainer][com.gestorfinances.app.di.AppContainer] always
