...
class DataSeeder(private val driver: SqlDriver) {
    ...
    fun seed() {
        ...
        execute("INSERT INTO movements (id, type, amount_cents, date, account_id, category_id, name, created_at, updated_at) VALUES ('m-apr-din1', 'expense', 4500, '2026-04-12', 'acc-main', 'cat-leisure', 'Restaurant Llesca', '2026-04-12T21:00:00Z', '2026-04-12T21:00:00Z');")
